...
class TestMetadataGeneration:
    ...
    def _extract_and_chunk_only(self, relative_path: Path, max_pages, chunker_cfg, quality_cfg, company_id: str, area_id: str):
        """Extract and chunk without embedding, generating reports for test mode. OPTIMIZED to extract only once."""
        ...
        print(f"[EXTRACCION] {relative_path.name}")

        # OPTIMIZATION: Use only ONE use case that does everything in one pass
