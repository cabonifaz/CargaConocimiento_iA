...
class BedrockCohereEmbedMultilingual(EmbedderPort):
    """Embedder para Cohere Embed Multilingual v3 en Bedrock.
    ...
    def __init__(
        ...
        self.model_id = model_id or "cohere.embed-multilingual-v3"
        ...
        self.total_tokens = 0
        self.total_cost = 0.0
        self.COST_PER_1M_TOKENS = 0.10  # $0.10 per 1M tokens for Cohere Embed Multilingual v3
    ...
    def embed_texts(self, texts: List[str]) -> List[list[float]]:
        ...
        print(f"### Bedrock Cohere Multilingual Embedder - embed_texts -> List[list[float]]")
        ...
        for i in range(0, len(texts), self.batch_size):
            ...
            # Cohere embeddings procesa un texto por invocación -> llamamos por cada item del batch
...
"""
    ...
    def _estimate_tokens(self, text: str) -> int:
        ...
        if TIKTOKEN_AVAILABLE:
            try:
                # Use cl100k_base (GPT-4) as approximation for Cohere embeddings
...
"""
    ...
    def _embed_one(self, text: str) -> list[float]:
        # Construcción del cuerpo según Cohere Embed Multilingual v3
        # Usar input_type "search_document" como default para documentos
        body = {
        ...
        while True:
            try:
                ...
                # Cohere retorna un array de embeddings, tomamos el primero
