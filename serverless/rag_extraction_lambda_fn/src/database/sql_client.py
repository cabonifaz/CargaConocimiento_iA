...
WORKER_NAME = "extraction-lambda"


class SQLServerClient:
    """Client for SQL Server operations during the extraction stage."""
    ...
    def iniciar_etapa(
        ...
        Args:
            ...
            id_etapa: Stage type — 1=Extracción, 2=Segmentación, 3=Vectorización
            estado_procesando: Processing state — 2, 4 or 6 (must match id_etapa)
    ...
    def completar_etapa(
        ...
        Args:
            ...
            estado_siguiente: Next queue state — 3, 5 or 7
            ruta_resultado: S3 key of the result file
            costo_usd: Cost of this stage in USD
